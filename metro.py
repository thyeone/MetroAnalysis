...
for i in range(int((len(metro_oct.columns) - 3) / 2)):
...
plt.title('2022년 10월 평균 승차 인원 수 Top10')
...
plt.title('2022년 10월 평균 하차 인원 수 Top10')
plt.show()
